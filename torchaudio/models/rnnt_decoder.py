...
class RNNTBeamSearch(torch.nn.Module):
    ...
    def _gen_next_token_probs(
        ...
        one_tensor = torch.tensor([1], device=device) # needs to change if context is increased
    ...
    def _search(
        ...
        for t in range(n_time_steps):
            ...
            _, sorted_idx = torch.tensor([self.hypo_sort_key(hypo_1) for hypo_1 in b_hypos]).topk(beam_width)
